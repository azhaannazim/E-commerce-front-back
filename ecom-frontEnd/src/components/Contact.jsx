...
const Contact = () => {
    return(
        <div
            ...
            style={{backgroundImage: "url('https://cdn.pixabay.com/photo/2019/02/17/18/26/handshake-4002834_1280.jpg')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">+91 8445345435</span>
                        </div>

                        <div className="flex items-center">
                            <FaEnvelope className="text-blue-500 mr-2"/>
                            <span className="text-gray-600">nazimazhaan17@gmail.com</span>
                        </div>

                        <div className="flex items-center">
                            <FaMapMarkedAlt className="text-blue-500 mr-2"/>
                            <span className="text-gray-600">MANIT, Bhopal</span>
                        </div>
                    </div>
                </div>
            </div>
